        ...
        <div class="row gutters-sm">
            ...
            <div class="p-3 py-1">
                ...
                <div class="row border-start border-end">
                          ...
                          <div class="col-sm-8 text-secondary border-start" id="no_ktp" ></div>
                        </div>
                        <hr>
                        <div class="row border-start border-end">
                          <div class="col-sm-4">
                          ...
                          <div class="col-sm-8 text-secondary border-start" id="ktp_almt">
                          </div>
                        </div>
                        <hr>
                        <div class="row border-start border-end">
                          ...
                          <div class="col-sm-8 text-secondary border-start" id="domisili_alamat"></div>
                        </div>
                        <hr>
                        <div class="row border-start border-end">
                          <div class="col-sm-4">
