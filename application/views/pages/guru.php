            ...
            <div class="row">
               ...
               <div class="card"> 
                    <div class="card-header border-2">
                        ...
                        <div class="col-10">
                        <h6> Guru <i class="fas fa-exclamation"></i></h6>
                </div>
                  ...
                  <div class="dropdown float-lg-end pe-4">
                    ...
                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                      ...
                      <li><a class="dropdown-item border-radius-md" href="<?= base_url('?p=tugas_arsip')?>">Arsip Materi</a></li>
                        ...
                        <div class="card-body">
                        <table id="tabel_guru" class="table table-bordered" style="width:100%">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-user"></i> Tambah Guru</h5>
      ...
      <div class="modal-body">
          <div class="row mb-3">
            ...
            <div class="col-md-8 col-xs-6">
              <input type="text" class="form-control" id="email" placeholder="Masukan Email Guru">
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-4 col-xs-6">
            ...
            <div class="col-md-8 col-xs-6">
              <input type="number" class="form-control" id="telp" placeholder="Masukan Nomor Telepon">
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-4 col-xs-6">
            ...
            <div class="col-md-8 col-xs-6">
              <input type="text" class="form-control" id="guru" placeholder="Masukan Nama Guru">
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-4 col-xs-6">
      ...
      <div class="modal-footer">
        ...
        <button id= "simpan_guru" type="button" class="btn btn-primary">Simpan</button>
      </div>
    </div>
    </div>
  </div>